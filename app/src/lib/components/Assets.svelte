<script context="module">
    ...
    export const cancel = (color = iconColor) => `
    <svg
    ...
    export const copy = `
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M14 8H4c-1.103 0-2 .897-2 2v10c0 1.103.897 2 2 2h10c1.103 0 2-.897 2-2V10c0-1.103-.897-2-2-2z"></path><path d="M20 2H10a2 2 0 0 0-2 2v2h8a2 2 0 0 1 2 2v8h2a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2z"></path></svg>`;

    export const move = `
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20 5h-9.586L8.707 3.293A.997.997 0 0 0 8 3H4c-1.103 0-2 .897-2 2v14c0 1.103.897 2 2 2h16c1.103 0 2-.897 2-2V7c0-1.103-.897-2-2-2zm-4 9H8v-2h8v2z"></path></svg>`;

    export const edit = (color = "red") => `
    <svg
    xmlns="http://www.w3.org/2000/svg"
    x="0px"
    y="0px"
    ...
    export const empty = (color = iconColor) => `
    <svg
    xmlns="http://www.w3.org/2000/svg"
    ...
    ><g
        ...
        ><path d="M0,172v-172h172v172z" fill="none" /><g fill="#9aa"
            ><path
                d="M143.33333,28.66667h-114.66667c-7.91917,0 -14.33333,6.41417 -14.33333,14.33333v86c0,7.91917 6.41417,14.33333 14.33333,14.33333h114.66667c7.91917,0 14.33333,-6.41417 14.33333,-14.33333v-86c0,-7.91917 -6.41417,-14.33333 -14.33333,-14.33333zM35.83333,121.83333l25.08333,-32.25l17.91667,21.57167l25.08333,-32.32167l32.25,43z"
            /></g
        ></g
    ></svg
>
    ...
    export const grid = (color = iconColor) => `
    <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    style="fill: ${color}"
    ...
    export const save = (color = iconColor) => `
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" style="fill: ${color};"
    ><path
    ...
    export const saved = (color = iconColor) => `
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" style="fill:${color}"
    ><path d="m11.998 17 7-8h-14z" /></svg
    >
    `;

    export const search = (color = iconColor) => `
    <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    style="fill: ${color}"
    ...
    export const slider = (color = iconColor) => `
    <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    style="fill:${color}"
    ...
    export const profile = (color = iconColor) => `<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 172 172"
    style=" fill:#000;"
    ><g
...
> `;
    ...
    export const collections = (color = iconColor) => `<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="1 1 22 22"
    style="fill: ${color};"
    ><path
...
>
`;
    export const add = (color = iconColor) => `
<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    style="fill: ${color}"
...
>`;
    ...
    export const refresh = (color = iconColor) => `<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    style=" fill:${color};"
>
